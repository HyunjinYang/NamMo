...
public class KatanaZeroScene3 : BaseScene
{
    ...
    {
        base.Init();
        SceneType = Define.Scene.KatanaZeroScene3;
        ...
        else
        {
            ...
            if (Managers.Scene.LastLocatedScene == Define.Scene.KatanaZeroScene2)
            {
                player.transform.position = _spawnPos1.position;
            }
            else if (Managers.Scene.LastLocatedScene == Define.Scene.KatanaZeroScene4)
            {
